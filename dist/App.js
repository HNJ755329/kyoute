...
class DeviationCalculator {
    constructor() {
        ...
        this.elements = {
            ...
            avgScoreInput: document.getElementById('avgScore'),
            ...
            extraInfoSpan: document.getElementById('extraInfo'),
            showVarianceHint: document.getElementById('showVarianceHint'),
            errorWarnSpan: document.getElementById('errorWarn')
        };
    ...
    // 偏差値から評価メッセージを生成
    getEvaluationMessage(deviation) {
        if (deviation >= 80) {
            return {
